...
public class DayVariantConfiguration : IEntityTypeConfiguration<DayVariant>
{
	public void Configure(EntityTypeBuilder<DayVariant> builder)
	{
		builder.ToTable( "DayVariants" );
