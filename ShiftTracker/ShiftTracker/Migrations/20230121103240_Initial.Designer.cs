...
namespace ShiftTracker.Migrations
{
    ...
    [Migration("20230121103240_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.Break", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.DailyRoutePlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.Run", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.Shift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.Shop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.Break", b =>
                {
                    b.HasOne("ShiftTracker.Areas.Shifts.Data.Models.Shift", "Shift")
                        .WithMany("Breaks")
            ...
            modelBuilder.Entity("ShiftTracker.Areas.Shifts.Data.Models.DailyRoutePlan", b =>
                {
                    b.HasOne("ShiftTracker.Areas.Shifts.Data.Models.Run", "Run")
                        .WithMany("RoutePlans")
                        .HasForeignKey("RunId");

                    b.HasOne("ShiftTracker.Areas.Shifts.Data.Models.Shop", "Shop")
